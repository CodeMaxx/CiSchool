...
container = "005056BB-0B24-0ed3-0000-858993527846"
idx = "005056BB-0B24-0ed3-0000-000268481962"

api_path = "/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f/policy/accesspolicies/{}/accessrules/{}".format(container, idx)    # param
url = server + api_path
if (url[-1] == '/'):
    url = url[:-1]
