...
url_name = json_resp['name']
url_idx = json_resp['id']
...
container = policy_idx

api_path = "/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f/policy/accesspolicies/{}/accessrules".format(container)    # param
url = server + api_path
if (url[-1] == '/'):
    url = url[:-1]
